...
public class CommandListExecutor extends CommandExecutor {

    public CommandListExecutor() {
        super(CommandKey.list, Arrays.stream(new ParamKey[] { ParamKey.remote_prefix }).collect(Collectors.toList()));
    }
