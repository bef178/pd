...
public class Test_DigestCodec {

    @Test
    public void test_md5sum() {
        DigestCodec md5Digest = DigestCodec.md5();
    ...
    public void test_sha1sum() {
        DigestCodec sha1Digest = DigestCodec.sha1();
    ...
    public void test_sha256sum() {
        DigestCodec sha256Digest = DigestCodec.sha256();
    ...
    public void test_sha512sum() {
        DigestCodec sha512Digest = DigestCodec.sha512();
