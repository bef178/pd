...
public class Test_CurlyBracketPattern {

    @Test
    public void test_format() {
        String pattern = "a/{}/b({})/c{}";
        assertEquals("a/1/b(2)/c3", CurlyBracketPattern.format(pattern, 1, 2, 3));
    }
    ...
    public void test_match() {
        ...
        String s = "a/1/b(2)/c3";
        Map<String, String> capturingGroups = CurlyBracketPattern.match(pattern, s);
